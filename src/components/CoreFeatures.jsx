      ...
      <section className="self-stretch grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-start justify-start gap-[48px] max-w-full text-left text-base text-blue-gray-900 font-body-s">
        <div className="flex-1 overflow-hidden flex flex-col items-start justify-center relative min-w-[296px] max-w-full">
          <div className="self-stretch flex flex-col items-start justify-start gap-[16px] max-w-full">
            ...
            <div className="self-stretch relative leading-[140%] font-body text-dark-75">
              ...
              different tools to view orders!
            </div>
          </div>
        </div>
        <div className="flex-1 overflow-hidden flex flex-col items-start justify-center relative min-w-[296px] max-w-full">
        ...
        <div className="flex-1 overflow-hidden flex flex-col items-start justify-center relative min-w-[296px] max-w-full">
          <div className="self-stretch flex flex-col items-start justify-start gap-[16px] max-w-full">
            ...
            <div className="self-stretch relative leading-[140%] font-body text-dark-75">
              Streamline communications with built-in messaging with customers.
              Never lose a conversation or customer request.
            </div>
          </div>
        </div>
    ...
    >
      <div className="flex-1 flex flex-col items-start justify-start gap-[40px]">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
          ...
          View and manage orders from all sources (mail-in, online, in-store) in
          one consolidated view. No more toggling between different tools to
          view orders!
          </div>
        </div>
        </div>
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
          ...
          <div className="self-stretch relative text-base leading-[140%] font-body text-dark-75">
            Easily create orders for in-store customers, send quotes, and build
            custom product and service offerings.
          </div>
          </div>
        </div>
        <div className="flex flex-row items-center gap-[24px]">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[8px]">
          ...
          <div className="self-stretch relative text-base leading-[140%] font-body text-dark-75">
          Dive into detailed insights on sales, customers, trends, and orders,
          and be empowered to run your business more efficiently.
          </div>
          </div>
        </div>
      </div>
