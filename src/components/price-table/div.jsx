...
const Div = ({ className = "", reports }) => {
  return (
    <div
      className={`bg-default-white self-stretch flex flex-col items-start justify-center pt-5 pb-[19px] pr-[171px] pl-8 gap-[8px] text-center text-base text-darksalmon font-body border-s-[0.5px] border-y-[0.5px] border-solid border-dark-25 mq450:pr-5 mq450:box-border ${className}`}
    >
