  ...
  return (
    ...
    >
      <div className="relative">
        ...
        />
        <div className="flex-1 overflow-hidden flex flex-col items-center justify-start md:p-20 p-4 box-border gap-[48px] max-w-full mq750:gap-[24px] mq750:py-[52px] mq750:px-10 mq750:box-border">
          <div className="flex flex-col items-center justify-start gap-[24px] max-w-full">
            <div className="flex flex-col items-center justify-start py-0 md:px-[72px] px-[0px] box-border gap-[8px] max-w-full text-xl">
              <h1 className="m-0 h-[123px] relative md:text-23xl text-3xl tracking-[0.02em] leading-[140%] font-bold font-sub-title text-transparent !bg-clip-text [background:linear-gradient(90deg,_#61ba5f,_#4c8c4a)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] inline-block">
